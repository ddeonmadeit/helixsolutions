...
// Orbit positions for items around center
...
const CharacterOnboarding = () => {
  ...
  const orbitRadius = typeof window !== "undefined" && window.innerWidth < 640 ? 140 : 180;
      ...
      {step < 2 ? (
        <div className="relative flex items-center justify-center w-full" style={{ height: orbitRadius * 2 + 80 }}>
          ...
          <div className="absolute z-10">
            <EvolvingCharacter stage={selectedFunctions.length} color={characterColor} />
          </div>
        ...
        >
          ...
          <div className="flex justify-center mb-6" style={{ transform: "scale(0.6)" }}>
            <EvolvingCharacter stage={selectedFunctions.length} color={characterColor} />
          </div>
