...
<head>
  ...
  <title>We missed you — Helix Solutions</title>
                ...
                <tr>
                  <td style="padding-bottom:28px;">
                    <p style="margin:0;font-size:15px;color:#8a9bb0;line-height:1.7;" class="text-muted">
                      It happens — life gets busy. We had a demo call scheduled but weren't able to connect with you.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td style="padding-bottom:28px;">
                    <p style="margin:0;font-size:15px;color:#8a9bb0;line-height:1.7;" class="text-muted">
                      <strong style="color:#e8edf2;" class="text-white">One small thing:</strong> please confirm your attendance 15 minutes before the call so we can make sure we're both ready to go. If something comes up, just reply to this email and we'll sort it out.
                    </p>
                  </td>
                </tr>
