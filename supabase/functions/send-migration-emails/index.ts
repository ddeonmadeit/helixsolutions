      ...
      email ? resend.emails.send({
        ...
        html: `
          <div style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; background: hsl(225, 30%, 6%); color: hsl(210, 20%, 92%); padding: 40px; border-radius: 16px; border: 1px solid hsl(220, 14%, 20%);">
            ...
            <p style="color: hsl(210, 20%, 75%); margin-bottom: 16px;">Thanks for completing the quiz! Based on your answers, an AI Employee could save your business:</p>
            <div style="background: hsl(185, 70%, 50% / 0.1); border: 1px solid hsl(185, 70%, 50%); border-radius: 12px; padding: 24px; text-align: center; margin-bottom: 24px;">
              <p style="font-size: 48px; font-weight: 800; color: hsl(185, 70%, 50%); margin: 0; line-height: 1;">${hoursSaved}</p>
              <p style="font-size: 16px; color: hsl(210, 20%, 92%); margin: 4px 0 0; font-weight: 600;">hours every week</p>
            </div>
            <p style="color: hsl(210, 20%, 75%); margin-bottom: 32px;">Book your same-day demo and we'll show you exactly how it works for your business.</p>
